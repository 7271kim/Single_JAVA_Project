...
public class ExcelWriteReadImpl implements ExcelWriteReadInter {
    ...
    @Override
    public void createCell(XSSFWorkbook workbook, int sheetNum, int rowNum, int cellNum, String cellContent) {
        XSSFRow row;
        XSSFCell cell;
        XSSFSheet sheet = workbook.getSheetAt( sheetNum );
        if( sheet != null){
    ...
    @Override
    public void modifyCell(XSSFWorkbook workbook, int sheetNum, int rowNum, int cellNum, String cellContent) {
        XSSFRow row;
        XSSFCell cell;
        XSSFSheet sheet = workbook.getSheetAt(sheetNum);
        if( sheet != null){
